...
seoTitle: "Memory That Compounds"
date: "2026-06-26"
excerpt: "Most AI memory just accumulates and rots. Parametric Memory captures a signal once, then compounds it — each session makes the next one cheaper."
author: "Glen Osborne"
...
*Parametric Memory is MCP-native and ships 11 tools for storing, recalling, training, and verifying memory. See the [docs](/docs/introduction) to wire it into Claude, Cursor, or your own agents.*
