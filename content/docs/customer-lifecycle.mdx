...
description: Every state your account and instance can be in — signup, provisioning, active, payment failure, read-only, cancellation — and how transitions work.
