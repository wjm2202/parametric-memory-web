...
**Overage pricing:** If you exceed your atom limit, excess atoms are billed at **$0.001 (USD) per atom per month** above your tier limit. This only applies if you deliberately work above the cap via the API. The MCP tools enforce the limit by default. All prices are in US dollars (USD).
