...
A spend cap is a maximum monthly spend limit in US dollars (USD). When your month-to-date spend (subscription + overages) approaches or exceeds the cap, the system:
...
2. Enter a limit in US dollars (USD) — must be between $0 and the platform ceiling
3. Save
...
- Your monthly subscription fee (Starter: $5, Solo: $9, Professional: $29, Team: $79)
- Atom overage charges ($0.01 per atom above tier limit per month)

The subscription fee alone may constitute most of your cap on lower tiers. For example, on Starter the subscription is $5 and the ceiling is $9 — you have $4 of headroom for overages before hitting the ceiling.
...
**Starter ($5 subscription, $9 ceiling):** You have $4 of headroom for overages. At $0.01 per excess atom, that covers 400 atoms above your tier limit before hitting the ceiling.
