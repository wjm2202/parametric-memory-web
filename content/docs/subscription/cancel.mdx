...
Your account is moved to an internal expired state during the grace period. This is not a publicly sold tier — it exists purely to retain your atom limits at a read-only level until the 30 days expire.
