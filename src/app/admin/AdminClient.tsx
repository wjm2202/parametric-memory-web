  ...
  if (!editing) {
    return (
      <div className="flex items-center gap-3" data-testid="persona-display">
        <h1 className="font-[family-name:var(--font-space-grotesk)] text-2xl font-bold">{display}</h1>
        <button
          type="button"
      ...
      <main className="relative mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mb-8">
          {substrate?.slug ? (
            ...
            <h1 className="mb-1 font-[family-name:var(--font-space-grotesk)] text-2xl font-bold">{slug}</h1>
          )}
