...
export default function BillingSuccessClient() {
  ...
  return (
    <>
      ...
      <main className="bg-surface-950 flex min-h-screen items-center justify-center px-4 pt-24 pb-16 sm:pt-28">
            ...
            <ol className="space-y-5">
              <li className="flex gap-4">
                ...
                <p className="text-surface-300 text-sm leading-relaxed">
                  Open <strong className="text-white">Claude Desktop</strong> → Settings → MCP
                  Servers
                </p>
              </li>
              <li className="flex gap-4">
