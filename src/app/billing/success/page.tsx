  ...
  return (
    <main className="bg-surface-950 flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-md text-center">
        ...
        <h1 className="text-surface-100 mb-3 text-2xl font-semibold">Payment successful</h1>
        <p className="text-surface-400 mb-2">
          Your account has been credited. It may take a few seconds to reflect in your balance.
        </p>
        <p className="text-surface-500 mb-8 text-sm">A receipt has been sent to your email.</p>
