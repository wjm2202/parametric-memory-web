  ...
  return (
    <>
      ...
      <main className="bg-surface-950 flex min-h-screen flex-col">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-amber-200/60 leading-relaxed">
                  ...
                  software under active development. <strong className="text-amber-200/80">Data loss is
                  possible</strong> before the v1.0.0 stable release. Anyone using the service prior
                  to v1.0.0 does so with full knowledge that storage guarantees are not yet in effect.
                </p>
                <p className="text-sm text-amber-200/60">
                  Paid plans are not available during the Beta. Use the{" "}
                  <a href="#early-access" className="text-amber-300 underline underline-offset-2 hover:text-amber-200">
        ...
        >
          <div className="rounded-2xl border border-brand-400/20 bg-gradient-to-b from-brand-500/5 to-surface-900/50 p-8 backdrop-blur-sm">
            <div className="mb-6 flex items-start gap-4">
              <div className="mt-0.5 flex-shrink-0 rounded-full bg-brand-500/15 p-2">
                <svg
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2">
                  <li className="flex items-start gap-2 text-sm text-surface-200/70">
                    ...
                    <span>
                      <strong className="text-white">Beta testers</strong> — developers who want to try
                      the service, stress-test the API, or build integrations before v1.0.0.
                    </span>
                  </li>
                  <li className="flex items-start gap-2 text-sm text-surface-200/70">
                    <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-brand-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span>
                      <strong className="text-white">Contributors</strong> — engineers and researchers
                      interested in the Markov-Merkle memory substrate itself: algorithms, proofs,
            ...
            {/* Email capture */}
            <div className="border-t border-surface-200/10 pt-6">
